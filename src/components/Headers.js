      ...
      <div id="main-slide" className="carousel slide" data-ride="carousel">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img className="d-block w-100" src="img/slider/slide2.png" alt="First slide" />
            <div className="carousel-caption d-md-block">
              
              <h1 className="wow fadeInDown heading" data-wow-delay=".4s" style={{fontFamily:'Cormorant Garamond' ,fontSize:'70px'}}>product</h1>
              <h1 className="wow fadeInDown heading" data-wow-delay=".4s" style={{fontFamily:'Cormorant Garamond' ,fontSize:'32px'}}>programs</h1>
